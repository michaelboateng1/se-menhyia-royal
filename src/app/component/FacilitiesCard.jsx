const FacilitiesCard = ({ facilityData }) => {
  ...
  return (
    <div className="rounded-[5px] w-[300px] h-[300px] relative overflow-hidden border-8 border-[#fff] cursor-pointer facilities-transition drop-shadow-md hover:shadow-lg">
      <img src={`/images/${image_url}`} alt="" className="w-full h-full object-cover transition-all duration-[0.3s] rounded-lg" />
