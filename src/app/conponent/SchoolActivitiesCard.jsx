const SchoolActivitiesCard = (props) => {
  const { cardImage, cardImageAltText, cardTitle, cardBody, instituteImage, instituteAltText } = props;
  return (
    <section className="bg-[#ffffff] activity-card">
      <div className="relative transition-all duration-[0.3s] activity-image">
      ...
      <div className="relative">
        ...
        {/* <img src={`/images/${instituteImage}`} alt={instituteAltText} className="h-[60px] absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%]" /> */}
      </div>
